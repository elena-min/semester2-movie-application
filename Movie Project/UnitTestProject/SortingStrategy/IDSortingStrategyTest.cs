...
{
    [TestClass]
    public class IDSortingStrategyTest
    {
        [TestMethod]
        public void GetSortedMediaItems_DescendingTest()
        {
            ...
            MediaItem movie3 = new Movie("Three", "Description3", DateTime.Now.AddDays(-5), "France", 6.3, "Director3", "Writer3", 94);
            ...
            var strategy = new IDSortingStrategy(descending: true);
            ...
            CollectionAssert.AreEqual(new MediaItem[] { movie4, movie2, movie1, movie3 }, result);
        ...
        public void GetSortedMediaItems_AscendningTest()
        {
            ...
            var strategy = new IDSortingStrategy();
            ...
            Assert.IsNotNull(result);
            Assert.AreEqual(mediaItems.Count, result.Length);
            CollectionAssert.AreEqual(new MediaItem[] { movie3, movie1, movie2, movie4 }, result);
