...
{
    [TestClass]
    public class ReleaseDateSortingStrategyTest
    {
        [TestMethod]
        public void GetSortedMediaItems_DescendingTest()
        {
            ...
            var strategy = new ReleaseDateSortingStrategy(descending: true);
            ...
            CollectionAssert.AreEqual(new MediaItem[] { movie3, movie4, movie1, movie2 }, result);
        ...
        public void GetSortedMediaItems_AscendningTest()
        {
            ...
            Assert.IsNotNull(result);
            Assert.AreEqual(mediaItems.Count, result.Length);
            CollectionAssert.AreEqual(new MediaItem[] { movie2, movie1, movie4, movie3 }, result);
